...
> A 3D split-box image gallery background built with CSS transform and JavaScript grid creation.

---

## 📌 Project Overview
**Background 3D Boxes** is a frontend web development project designed to showcase core web concepts, DOM manipulation, and responsive UI design. Built using vanilla web technologies without external frameworks.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/mohsinshah12309/background-3d-boxes.git
   ```
